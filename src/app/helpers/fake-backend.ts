...
export function fakeBackendFactory(backend: MockBackend, options: BaseRequestOptions) {
  let token =
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkFtbWFyIFZlaGJpIE1lcmFrbGkiLCJhZG1pbiI6dHJ1ZX0.OdzOICh98uhExKhOOoMnZwmvOIJqz9DR27iH5vWWots';
  ...
  backend.connections.subscribe((connection: MockConnection) => {
    ...
    setTimeout(() => {
      ...
      if (
        ...
        if (body.email === 'merakli.vehbi@gmail.com' && body.password === '123456') {
